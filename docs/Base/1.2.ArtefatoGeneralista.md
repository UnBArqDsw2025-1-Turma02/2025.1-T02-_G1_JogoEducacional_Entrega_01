...
Embora o projeto não envolva gastos reais, simulamos um custo com base no tempo médio de dedicação de um estudante universitário.

### Premissas:
- 10 estudantes trabalhando 6h/semana por 9 semanas (~54h por pessoa)
- Valor-hora simulado: **R$ 20,00/h**
...
|-------------------------|------------------|----------------|--------------|
| Horas de trabalho       | 10 x 54h         | R$ 20,00       | R$ 10.800,00 |
| Ferramentas e recursos  | Gratuitos        | —              | R$ 0,00      |
| **Total (fictício)**    | —                | —              | **R$ 10.800,00** |
...
| `1.8`  | 10/04/2025 | Adição do Custo e Tempo | [Diogo Barboza](https://github.com/diogo-barboza) | [Cristiano Borges](https://github.com/CristianoMoraiss) |
